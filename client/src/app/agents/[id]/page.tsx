/* /agents/:id — Agent Editor (A2, L03). Left agent list + the two-tab editor
   (Config · Skills). Tab state lives in ?tab=. */
"use client";
...
import { DEFAULT_TAB, TAB_KEYS } from "./_components/AgentEditor/constants";
