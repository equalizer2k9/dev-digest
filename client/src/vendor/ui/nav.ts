...
export const NAV: NavGroup[] = [
  ...
  {
    // Skills Lab — what an agent is made of: the skills, and the agents that
    // assemble them into a prompt. `agents` moved here from WORKSPACE; its
    // href, key and `g a` chord are unchanged.
    section: "SKILLS LAB",
    items: [
