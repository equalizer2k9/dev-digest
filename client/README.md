...
flowchart TD
  ...
  SKILLS["/skills<br/>skills grid"] --> SKILL["/skills/:id<br/>config · preview · versioning"]
  ...
  SKILLS -->|"/skills · /skills/import(/preview)"| API
  SKILL -->|"/skills/:id · /skills/:id/versions · /restore"| API
